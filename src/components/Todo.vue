<template>
  <div class="col-6 mb-2">
    ...
    >
      <div>{{ todo.text }}</div>
      <div>
        <button type="button" class="btn btn-info btn-sm" @click="enableEdit">
          edit
        </button>
        <button
          type="button"
    ...
    <div
      ...
      v-if="editMode === true"
    >
      <div><input type="text" v-model="todoText" /></div>
      <div>
        <button type="button" class="btn btn-info btn-sm" @click="editTodo">
          edit
        </button>
      </div>
    </div>
